let sonido_ganador = new Audio("audio/sonido_ganador.ogg");
let sonido_win = new Audio("audio/sonido_win.ogg");
let sonido_perdedor = new Audio("audio/sonido_perdedor.ogg");
let sonido_gameover = new Audio("audio/sonido_gameover.ogg");
let sonido_descubrir = new Audio("audio/sonido_descubrir.ogg");
let sonido_juegonuevo = new Audio("audio/sonido_nuevojuego.ogg");
let sonido_abrirarea = new Audio("audio/sonido_abrirarea.ogg");
let sonido_marca = new Audio("audio/sonido_marca.ogg");
